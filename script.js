// =====================================================================
// 1. LISTAS de GIFs e MP3 (adicione ou remova à vontade)
...
perguntaInp.addEventListener("keydown", e => {
    if (e.key === "Enter" && !e.shiftKey) {  // só Enter, sem Shift
      e.preventDefault();                    // evita quebrar linha
      enviarBtn.click();                     // dispara o mesmo handler do botão
    }
  });
...
// toca menu depois do 1º clique permitido pelo navegador
